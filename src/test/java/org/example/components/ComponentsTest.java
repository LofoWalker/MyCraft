...
class ComponentsTest {
    ...
    void playerInputAttachable() {
        world.add(player, new PlayerInput(true, false, false, false, false, false, 0.3f, -0.1f, false, false,
    ...
    void allComponentsOnSameEntity() {
        ...
        world.add(player, new CameraComponent(70f, 0.1f, 1000f));
        world.add(player, new PlayerInput(false, false, false, false, false, false, 0, 0, false, false,
                false, 0, WorldConstants.NO_HOTBAR_SELECT, false));
        world.add(player, new Gravity(9.81f));
        world.add(player, new ColliderAABB(0.6f, 1.8f, 0.6f));
