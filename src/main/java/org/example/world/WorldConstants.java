...
public final class WorldConstants {
    ...
    // Mob drop item ids (non-block, non-tool; sit in the 100s alongside food).
    public static final int ITEM_LEATHER = 102;
    public static final int ITEM_BEEF    = 103;
    public static final int ITEM_PORK    = 104;
    public static final int ITEM_WOOL    = 105;
    public static final int ITEM_FEATHER = 106;
